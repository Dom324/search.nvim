local text_tree = require("my_awesome_plugin.text_tree")
        ...
        n.rows(
            ...
            n.columns(
                ...
                n.button({
                    ...
                    on_press = function()
                        signal.reset_signal_state_and_component_buffers(renderer)
                    end,
                }),
                n.button({
                    ...
                    on_press = function()
                        ...
                        if curr_search_cwd == enums.cwd.PROJECT then
                            signal.query_signal.search_cwd = enums.cwd.GLOBAL
                            signal.query_signal.search_cwd_str = enums.cwd_str.GLOBAL
                        else
                            signal.query_signal.search_cwd = enums.cwd.PROJECT
                            signal.query_signal.search_cwd_str = enums.cwd_str.PROJECT
                        end
                    end,
                }),
                n.checkbox({
